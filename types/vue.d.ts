...
import {
  Component, //组件 
  AsyncComponent, //异步组件
  ComponentOptions,//组件options
  FunctionalComponentOptions, //函数式组件options
  WatchOptionsWithHandler, //watchOptions
  WatchHandler,//watch处理器
  DirectiveOptions, //指令options
  DirectiveFunction,//指令方法
...
export interface Vue {
  readonly $el: Element; //当前vue实例对应的真实dom
  readonly $options: ComponentOptions<Vue>; //当前组件的options
  readonly $parent: Vue; //当前
  readonly $root: Vue;
